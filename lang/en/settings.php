...
return [
    ...
    'maint_recycle_bin_desc' => 'Deleted shelves, books & pages are sent to the recycle bin so they can be restored or permanently deleted. Older items in the recycle bin may be automatically removed after a while depending on system configuration.',
    ...
    'role_manage_entity_permissions' => 'Manage all book and page permissions',
    'role_manage_own_entity_permissions' => 'Manage permissions on own book & pages',
    ...
    'role_asset_desc' => 'These permissions control default access to the assets within the system. Permissions on Books and Pages will override these permissions.',
